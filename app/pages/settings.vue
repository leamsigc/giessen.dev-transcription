...
const { selectedMicrophone, microphones, getMicrophones, saveMicrophoneSelection, loadMicrophoneSelection } = useMicrophone()
...
<template>
  <UContainer class="py-8">
    <div class="max-w-2xl mx-auto">
      ...
      <UCard class="mb-6">
        <template #header>
          <h2 class="text-xl font-semibold">Microphone Settings</h2>
        </template>
        ...
        <div class="space-y-4">
          ...
          <div class="flex gap-2">
            <UButton @click="getMicrophones" variant="outline" size="sm">
              Refresh Microphones
            </UButton>
            <UButton @click="saveSettings" color="primary" size="sm">
              Save Settings
            </UButton>
          </div>
        </div>
